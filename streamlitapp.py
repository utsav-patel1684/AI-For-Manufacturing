...
uploaded_model = st.file_uploader("Upload your trained `.pkl` model file", type=["pkl"])

if uploaded_model is not None:
    try:
        # Solution 1 - Load model properly from uploaded file using BytesIO
        voting_model = pickle.load(io.BytesIO(uploaded_model.read()))
